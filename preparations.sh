...
ruby bin/preparations/snv_markup.rb  ./source_data/SNV_infos_original.txt  ./source_data/cage_peaks.txt  ./source_data/exons.txt  >  ./source_data/SNV_infos_marked_up.txt
