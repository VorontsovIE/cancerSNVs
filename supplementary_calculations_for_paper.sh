...
# ls ./results/fitted_sites/any/sites_cancer.txt | ruby bin/supplementary/snv_positions_in_motif_site.rb  --expand-region 11  --motif ${CONSIDERED_MOTIFS} --folder ./results/disruption_position_profile/any/cancer
# ls ./results/fitted_sites/any/sites_random_genome_*.txt | ruby bin/supplementary/snv_positions_in_motif_site.rb  --expand-region 11  --motif ${CONSIDERED_MOTIFS} --folder ./results/disruption_position_profile/any/genome/
# ls ./results/fitted_sites/any/sites_random_shuffle_*.txt | ruby bin/supplementary/snv_positions_in_motif_site.rb  --expand-region 11  --motif ${CONSIDERED_MOTIFS} --folder ./results/disruption_position_profile/any/shuffle/ 
