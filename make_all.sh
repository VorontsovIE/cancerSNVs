...
# 40 sec each
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/cancer_wo_repeats.txt --contexts TCN --mutation-types promoter,intronic > ./results/intermediate/site_subsets/cancer_tpc.txt
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/cancer_wo_repeats.txt --contexts NCG --mutation-types promoter,intronic > ./results/intermediate/site_subsets/cancer_cpg.txt
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/cancer_wo_repeats.txt --mutation-types promoter,intronic > ./results/intermediate/site_subsets/cancer_any.txt
# 15 min each
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/random_wo_repeats.txt --contexts TCN --mutation-types promoter,intronic > ./results/intermediate/site_subsets/random_tpc.txt
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/random_wo_repeats.txt --contexts NCG --mutation-types promoter,intronic > ./results/intermediate/site_subsets/random_cpg.txt
ruby bin/preparations/filter_mutations.rb ./source_data/SNV_infos.txt ./results/intermediate/SNV_sequences.txt ./results/intermediate/site_subsets/random_wo_repeats.txt --mutation-types promoter,intronic > ./results/intermediate/site_subsets/random_any.txt
