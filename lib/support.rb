...
def motifs_in_set(mutated_site_infos_filename, mutations_subset)
  count_each_motif_mutations(mutated_site_infos_filename, &is_site_and_in_set_checker(mutations_subset))
end
##############
