...
class MotifCollectionStatistics
  ...
  class MotifStatisticsCorrected
    ...
    def_delegators :@motif_statistics_uncorrected, :motif, :gene, :quality, :official_gene_name, :underfitted,
                                                   ...
                                                   :cancer_disruption_rate, :random_disruption_rate,
                                                   :cancer_to_random_disruption_ratio, :cancer_emergence_rate,
                                                   :random_emergence_rate, :cancer_to_random_emergence_ratio
    ...
    def self.from_string(line)
      motif, official_gene_name, quality,
          ...
          _cancer_disruption_rate, _cancer_emergence_rate, _random_disruption_rate, _random_emergence_rate,
