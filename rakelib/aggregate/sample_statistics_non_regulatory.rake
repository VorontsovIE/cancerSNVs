...
task :sample_statistics_all_SNVs do
  ...
  Configuration.getAlexandrovWholeGenomeCancers.each{|cancer_type|
    context_counts = context_counts_in_file(File.join('results/AllSNVs', 'Alexandrov', cancer_type.to_s, 'cancer.txt'))
    short_context_counts = short_context_counts_in_file(File.join('results/AllSNVs', 'Alexandrov', cancer_type.to_s, 'cancer.txt'))
  ...
  Configuration.getYeastApobecSamples.each{|cancer_type|
    context_counts = context_counts_in_file(File.join('results/AllSNVs', 'YeastApobec', cancer_type.to_s, 'cancer.txt'))
    short_context_counts = short_context_counts_in_file(File.join('results/AllSNVs', 'YeastApobec', cancer_type.to_s, 'cancer.txt'))
  ...
  context_counts = context_counts_in_file(File.join('results/AllSNVs', 'NikZainal', 'cancer.txt'))
  short_context_counts = short_context_counts_in_file(File.join('results/AllSNVs', 'NikZainal', 'cancer.txt'))
  ...
  File.open('results/motif_statistics/all_SNVs_sample_statistics.tsv', 'w'){|fw|
    print_matrix(matrix.transpose, stream: fw)
  }
  File.open('results/motif_statistics/all_SNVs_sample_statistics_wo_mutation_direction.tsv', 'w'){|fw|
  ...
  File.open('results/motif_statistics/all_SNVs_sample_statistics_rates.tsv', 'w'){|fw|
  ...
  File.open('results/motif_statistics/all_SNVs_sample_statistics_rates_wo_mutation_direction.tsv', 'w'){|fw|
