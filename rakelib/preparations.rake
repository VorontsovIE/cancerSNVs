...
namespace 'preparations' do
  namespace 'extractSNVs' do
    ...
    file LocalPaths::Secondary::NikZainalSNVs => [:load_markup, LocalPaths::Secondary::NikZainalSNVsOriginal] do
    ...
    task :Alexandrov => [:load_markup] do
